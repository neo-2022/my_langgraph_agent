...
- [x] Сделать базовый layout:
  ...
  - [x] основная область с вкладками (пока заглушки/постепенно оживают)
- [x] Сайдбар: перенести настройки из текущего Settings UI:
  - [x] выбор модели + “Сохранить” (в UI уже есть выбор/запросы)
  - [x] кнопка “Перезапустить LangGraph” (в React UI)
...
- [ ] (IN PROGRESS) Документация запуска UI в README (есть, но нужно привести в порядок и усилить)
